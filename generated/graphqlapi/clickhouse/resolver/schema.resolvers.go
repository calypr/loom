...
func (r *dataframeAggregationsResultResolver) Aggregations(ctx context.Context, obj *model.DataframeAggregationsResult) (json.RawMessage, error) {
	...
	value, err := json.Marshal(obj.Aggregations)
	if err != nil {
...
// DataframeAggregationsResult returns executor.DataframeAggregationsResultResolver implementation.
func (r *Resolver) DataframeAggregationsResult() executor.DataframeAggregationsResultResolver {
