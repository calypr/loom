// Package datasetstore persists the immutable dataset generation lifecycle in
// ArangoDB.
//
...
// never stores raw authorization paths, tokens, subjects, claims, or a
// dataset.AuthScopeFingerprint: authorization scope is a per-read concern,
// not persistent generation metadata.
//
