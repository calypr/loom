// Package runtime owns catalog-aware dataframe preparation and execution.
//
// Deprecated compatibility aliases in compatibility.go keep existing direct
// runtime importers source-compatible. New callers should import request and
// compiler contracts from their canonical spec/compiler owners instead.
package runtime
