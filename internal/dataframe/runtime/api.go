...
// Compiler contracts are aliased here so the runtime can preserve the
// historical unqualified names internally.
package runtime
...
type (
	...
	RunRequest                             = compiler.RunRequest
	Result                                 = compiler.Result
	QueryDiagnostics                       = compiler.QueryDiagnostics
	StreamResult                           = compiler.StreamResult
