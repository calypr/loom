// Package arango provides the durable recipeexec.Store adapter used by Loom
...
func (r *Registry) SaveRecipe(ctx context.Context, entry recipeexec.Entry) error {
...
func (r *Registry) LoadRecipe(ctx context.Context, name string) (recipeexec.Entry, error) {
	var found *recipeexec.Entry
