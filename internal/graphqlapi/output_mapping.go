...
func fieldHints(in []dataframebuilder.FieldHint) []*model.DataframeFieldHint {
	if len(in) == 0 {
...
func resourceHints(in dataframebuilder.ResourceHints) *model.DataframeResourceHints {
...
func relatedResourceHints(in []dataframebuilder.RelatedResourceHints) []*model.DataframeRelatedResourceHints {
	if len(in) == 0 {
...
func selectorModelFromExpression(expression string) *model.DataframeFieldSelector {
	...
	parts := dataframebuilder.DecomposeSelector(expression)
