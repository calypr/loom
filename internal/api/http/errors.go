...
var httpCodePolicies = map[string]httpCodePolicy{
	...
	"RELATIONSHIP_CARDINALITY_VIOLATION": {http.StatusUnprocessableEntity}, "TEMPORAL_ANCHOR_INVALID": {http.StatusUnprocessableEntity}, "TEMPORAL_PRECISION_UNSUPPORTED": {http.StatusUnprocessableEntity}, "TEMPORAL_TIE_AMBIGUOUS": {http.StatusUnprocessableEntity}, "UNIT_IDENTITY_UNKNOWN": {http.StatusUnprocessableEntity}, "UNIT_DIMENSION_INCOMPATIBLE": {http.StatusUnprocessableEntity},
